...
namespace Assets.Scripts.Extensions
{
    public static class InputActionExtensions
    {
        ...
        public static void UnHook(this InputAction action, Action<InputAction.CallbackContext> onPerformed = default, Action<InputAction.CallbackContext> onStarted = default, Action<InputAction.CallbackContext> onCancelled = default)
        {
            if (action != default)
            {
                if (onPerformed != default)
